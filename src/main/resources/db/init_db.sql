...
/*!40000 ALTER TABLE `app_user_authority` DISABLE KEYS */;
INSERT INTO `app_user_authority` VALUES (2,'admin'),(1,'user');
/*!40000 ALTER TABLE `app_user_authority` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `authority` VALUES ('admin'),('user');
...
INSERT INTO `category` VALUES (1,'Phim bộ'),(2,'Phim Lẻ'),(3,'Phim Chiếu Rạp');
...
INSERT INTO `comment` VALUES (1,'dsf',2);
...
INSERT INTO `episode` VALUES (214,'ádf',2,NULL,NULL,116),(215,'Hay',1,NULL,NULL,116),(217,'sadf',3,NULL,NULL,116);
...
INSERT INTO `evaluation` VALUES (12,101,3,2),(13,112,4,2);
...
INSERT INTO `genre` VALUES (1,'Hành động'),(2,'Kinh dị'),(3,'Hài Hước');
...
INSERT INTO `movie` VALUES (112,'Mỹ','Walk Alone','Walk Alone','Walk Alone','movies/112/poster/alone.jpg','Walk Alone','movies/112/video/Let Us In - Official Trailer.mp4',1992,3,NULL),(113,'Mỹ','Joker','Joker','Joker',NULL,'Joker',NULL,1998,NULL,NULL),(116,'Hồng Kông','Đội  Bóng Thiếu Lâm','Đội  Bóng Thiếu Lâm','Đội  Bóng Thiếu Lâm','movies/116/poster/tải xuống (5).jpg','Đội  Bóng Thiếu Lâm','movies/116/video/tải xuống (5).jpg',1998,1,NULL);
...
INSERT INTO `movie_genres` VALUES (113,1),(116,1),(113,2),(112,3),(113,3);
...
/*!40000 ALTER TABLE `movie_package` DISABLE KEYS */;
/*!40000 ALTER TABLE `movie_package` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user` VALUES (1,'string','string','$2a$10$Q53wEDhdcejQAzeKsUbJf../6TFyXvNVEB/DXdGK2F3BwYDmkSsgC','user'),(2,'string','string','$2a$10$MBX.VU61fURB7eQvEVMNFOt22MgKGuw/4YwNOQfKyUWS8PvEMoNja','admin');
